...
class Connexion
{
    ...
    //final -> on ne peut pas en hériter
    {
        ...
        if (is_null(self::$connection))
        {
            ...
            try 
            {
                self::$connection = new PDO('mysql:host=' . self::$host . ';dbname=' . self::$base, self::$user, self::$pass, array(PDO::ATTR_DEFAULT_FETCH_MODE =>PDO::FETCH_ASSOC, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
